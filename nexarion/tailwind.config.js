    ...
    themes: [
      {
        "nexarion-dark": {
          ...
          "--rounded-box": "0.5rem",      // radius-box
          "--rounded-btn": "0.5rem",      // radius-btn
          "--rounded-badge": "0.5rem",    // radius-badge
          "--animation-btn": "0",         // example, adjust as needed
          "--btn-border-width": "2px",   // border
          // add any other variables you want to customize here
        },
      },
      "dark", // optionally include the default dark theme as fallback
    ],
    defaultTheme: "nexarion-dark", // if you want this theme default on load
  },
};